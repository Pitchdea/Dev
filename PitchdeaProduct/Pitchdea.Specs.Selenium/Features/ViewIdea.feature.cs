...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("GREAT IDEA", "0123456789", "", null)]
        [NUnit.Framework.TestCaseAttribute("So-Good-Idea?", "Virtual piano lessons `?=)(/&%¤#\"!@£$€{[]} \\ ~*\'^ <>", "I am an alcoholic and have too much spare time so I could think I would be a good" +
            " teacher", null)]
        [NUnit.Framework.TestCaseAttribute("", "", "weird characters on label `?=)(/&%¤#\"!@£$€{[]} \\ ~*\'^ <>", null)]
        [NUnit.Framework.TestCaseAttribute("title", "summary", "multiline text", null)]
